...
<body>
    <div class="container">
        <center>
            ...
            <p class="message"><span data-tid="elements_examples.success.message">Thanks for your order, we sent your receipt to your email</span><span class="token">tok_1GAhh62eZvKYlo2CzecBXMOh</span></p>
            <a class="reset" href="/store">
